...
var skel = function () {
    ...
    nn = {
        ...
        applyRowTransforms: function (e) {
            ...
            s,
            a;
            for (s = 1; s <= nn[l]; s++) a = nn[o]("important(" + nn[L].k[s] + ")"),
            nn[n](a,
            function (e) {
                i[W](a[e])
            });
        ...
        changeState: function (o) {
            ...
            if (!nn[C][bt][nn[i]]) {
                ...
                k = "mV" + nn[i],
                c[t][p].content ? A = c[t][p].content : nn.isLocked() ? (g = [], g[W]("user-scalable=yes"), nn[w][G][0] && g[W]("width=" + nn[w][G][0]), nn[w][G][1] && g[W](tn + nn[w][G][1]), A = g.join(","), window.setTimeout(function () {
                    nn.poll()
                },
                0)) : (g = [], g[W]("user-scalable=" + (c[t][p].scalable ? "yes" : "no")), c[t][p].width && g[W]("width=" + c[t][p].width), c[t][p].height && g[W](tn + c[t][p].height), c[t][p].width == yt && g[W](wt), A = g.join(",")),
                ...
                nn[n](a,
                function (i) {
                    nn[e][a[i]][t][Gt] && (k = "ss" + a[i], (E = nn[h](k)) || (E = nn[v](k, nn.newStyleSheet(nn[e][a[i]][t][Gt]), I, 5)), c[r][W](E)),
                    nn[e][a[i]][r][f] > 0 && nn[n](nn[e][a[i]][r],
                    function (t) {
                        c[r][W](nn[e][a[i]][r][t])
                    })
                }),
        ...
        poll: function () {
            ...
            e = nn.getStateId(),
            e === "" && (e = nn.sd),
            e !== nn[i] && (nn[pt] ? nn.changeState(e) : (nn[k][Pt][M] = nn[k][Pt][M][F](nn[i][x](1)[F](new RegExp(nn.sd, "g"), " "), ""), nn.changeState(e), nn[k][Pt][M] = nn[k][Pt][M] + " " + nn[i][x](1)[F](new RegExp(nn.sd, "g"), " "), nn[k][Pt][M][it](0) == " " && (nn[k][Pt][M] = nn[k][Pt][M][x](1))))
        },
        ...
        initAPI: function () {
            ...
            nn[w][ut] = 99,
            e = "other",
            r[H](/Firefox/) ? e = "firefox" : r[H](/Chrome/) ? e = "chrome" : r[H](/Safari/) && !r[H](/Chrome/) ? e = "safari" : r[H](/(OPR|Opera)/) ? e = "opera" : r[H](/MSIE ([0-9]+)/) ? (e = "ie", nn[w][ut] = RegExp.$1) : r[H](/Trident\/.+rv:([0-9]+)/) && (e = "ie", nn[w][ut] = RegExp.$1),
            nn[w].browser = e,
            nn[w][O] = "other",
            t = {
        ...
        initConfig: function (i) {
            ...
            function (n) {
                ...
                "range" in s && (u = s.range, u == "*" ? a = "" : u[it](0) == "-" ? a = "(max-width: " + parseInt(u[x](1)) + "px)" : u[it](u[f] - 1) == "-" ? a = Dt + parseInt(u[x](0, u[f] - 1)) + "px)" : nn[U](u, "-") != -1 && (u = u[xt]("-"), a = Dt + parseInt(u[0]) + "px) and (max-width: " + parseInt(u[1]) + "px)"), s[Mt] = a),
                B in s && (b in s[B] && !nn[P](s[B][b]) && (s[B][b] = [s[B][b], s[B][b]]), "zoom" in s[B] && (s[B][ct] = s[B].zoom), ct in s[B] && (nn[l] = Math.max(nn[l], s[B][ct]))),
                nn[t][e][n] = s,
                i = {},
        ...
        initEvents: function () {
            var e; !nn[t].pollOnce && !nn[pt] && (nn.on(Tt,
            function () {
                nn.poll()
            }), nn.on(A,
            function () {
        ...
        initUtilityMethods: function () {
            ...
            window.matchMedia ? nn[V] = function (e) {
                ...
                n = e[xt](/\s+and\s+/);
                for (i in n) t = n[i],
                t[it](0) == "(" && (t = t[x](1, t[f] - 1), r = t[xt](/:\s+/), r[f] == 2 && (s[r[0][F](/^\s+|\s+$/g, "")] = parseInt(r[1]), o = y));
                if (!o) return u;
