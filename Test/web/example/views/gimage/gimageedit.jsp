                ...
                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-content">
                            ...
                            <form class="form-horizontal" action="gimageUpdate" method="POST">
                                <fieldset>
                                    <div class="control-group">
                                        <label class="control-label">商店ID</label>
                                        <div class="controls">
                                            <input name="shopId" class="input-xlarge"  type="text" value="${requestScope.gimageEdi.shopId}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="desc">食物图片</label>
                                        <div class="controls">
                                            <input name="gplace" class="input-xlarge focused" id="desc" type="text" value="${requestScope.gimageEdi.gplace}">
                                        </div>
                                    </div>	
                                    <div class="control-group">
                                        <label class="control-label" for="desc">图片ID</label>
                                        <div class="controls">
                                            <input name="gid" class="input-xlarge focused" id="desc" type="text" readonly="true" value="${requestScope.gimageEdi.gid}"/>
                                        </div>
                                    </div>
