                ...
                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-content">
                            ...
                            <form class="form-horizontal" action="goodUpdate" method="POST">
                                <fieldset>
                                    <div class="control-group">
                                        <label class="control-label">商品名</label>
                                        <div class="controls">
                                            <input name="goodname" class="input-xlarge"  type="text" value="${requestScope.goodEdi.goodname}">
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label" for="orderid">进价</label>
                                        <div class="controls">
                                            <input name="inprice" class="input-xlarge focused" id="orderid" type="text" value="${requestScope.goodEdi.inprice}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="num">售价</label>
                                        <div class="controls">
                                            <input name="saleprice" class="input-xlarge focused" id="num" type="text" value="${requestScope.goodEdi.saleprice}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="num">生产日期</label>
                                        <div class="controls">
                                            <input name="pdate" class="input-xlarge focused" id="num" type="text" value="${requestScope.goodEdi.pdate}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="num">销售量</label>
                                        <div class="controls">
                                            <input name="salenumber" class="input-xlarge focused" id="num" type="text" value="${requestScope.goodEdi.salenumber}">
                                        </div>
                                    </div> 
                                    <div class="control-group">
                                        <label class="control-label" for="desc">图片</label>
                                        <div class="controls">
                                            <input name="goodimage" class="input-xlarge focused" id="desc" type="text" value="${requestScope.goodEdi.goodimage}">
                                        </div>
                                    </div>	
                                    <div class="control-group">
                                        <label class="control-label" for="desc">商店ID</label>
                                        <div class="controls">
                                            <input name="shopId" class="input-xlarge focused" id="desc" type="text" value="${requestScope.goodEdi.shopId}"/>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="desc">商品ID</label>
                                        <div class="controls">
                                            <input name="goodId" class="input-xlarge focused" id="desc" type="text" readonly="true" value="${requestScope.goodEdi.goodId}"/>
                                        </div>
                                    </div>
