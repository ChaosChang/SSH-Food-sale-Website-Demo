        ...
        <div class="content">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="row-fluid">
                            <div class="btn-toolbar">
                                <a href="${pageContext.request.contextPath}/example/views/good/goodadd.jsp" role="button" class="btn btn-primary" data-toggle="modal">
                                ...
                                <tbody>
                                    <c:forEach items="${goodlist}" var="g">
                                        <tr>
                                            ...
                                            <td><img src="${g.goodimage}" height="100" width="100"/></td>
                                            <td>
                                                <a  class="btn btn-info" href="goodEdit.action?goodId=${g.goodId}"><i class="icon-edit icon-white"></i>修改</a>
                                                <button  onclick="del(this)"  delid="${g.goodId}" class="btn btn-danger"><i class="icon-trash icon-white"></i> 删除</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
            ...
            <script type="text/javascript">
                ...
                function del(obj) {
                    ...
                    var delurl = "goodRemove.action?goodId="+delid;
                    $("#myModal").modal("show").on("shown", function () {
                        $("#delbtn2").attr('href', delurl);
                    });
                }
