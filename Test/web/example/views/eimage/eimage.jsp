        ...
        <div class="content">
            ...
            <!-- 提示框2 -->
                ...
                <div class="header">
                    ...
                    <h1 class="page-title">环境</h1>
                </div>

                <ul class="breadcrumb">
                    <li>环境 <span class="divider">/</span></li>
                    <li class="active">环境查询</li>
                </ul>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="row-fluid">
                            <div class="btn-toolbar">
                                <a href="${pageContext.request.contextPath}/example/views/eimage/eimageadd.jsp" role="button" class="btn btn-primary" data-toggle="modal">
                        ...
                        <div class="well">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tbody>
                                    <c:forEach items="${eimagelist}" var="e">
                                        <tr>
                                            <td>${e.eid}</td>
                                            <td>${e.shopId}</td>
                                            <!--c:if test="$">
                                            ...
                                            <td><img src="${e.eplace}" height="150" width="200"/></td>
                                            <td>
                                                <a  class="btn btn-info" href="eimageEdit.action?eid=${e.eid}"><i class="icon-edit icon-white"></i>修改</a>
                                                <button  onclick="del(this)"  delid="${e.eid}" class="btn btn-danger"><i class="icon-trash icon-white"></i> 删除</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
            ...
            <script type="text/javascript">
                ...
                function del(obj) {
                    ...
                    var delurl = "eimageRemove.action?eid="+delid;
                    $("#myModal").modal("show").on("shown", function () {
                        $("#delbtn2").attr('href', delurl);
                    });
                }
