...
<html>
    ...
    <body>
            ...
            <div class="container">
                <div class="top-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/example/events.jsp" class="active">特色环境</a></li>
        ...
        <!--end-banner-->
        <form action="searchShop1" method="post">
        ...
        <div class="content">
            <div class="events-section">
                <div class="container">
                    <h3>Especially Environment</h3>
                    <div class="events-grids">
                        <div class="events1">
                            <c:forEach items="${currenteimage}" var="ce">
                                <div class="col-md-4 event-grid">
                                    <a href="#" class="mask">
                                        <img src="${ce.eplace}" class="img-responsive zoom-img" alt="">
                                    </a>
                                    <h4>&nbsp;</h4>
                                </div>
                            </c:forEach>
