        ...
        <div class="content">
                                ...
                                <tbody>
                                    <c:forEach items="${orderlist}" var="o">
                                        <tr>
                                            ...
                                            <td>
                                                <a  class="btn btn-info" href="orderDetail.action?orderId=${o.orderId}"><i class="icon-edit icon-white"></i>查看详情</a>
                                                <button  onclick="del(this)"  delid="${o.orderId}" class="btn btn-danger"><i class="icon-trash icon-white"></i> 删除</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
            ...
            <script type="text/javascript">
                ...
                function del(obj) {
                    ...
                    var delurl = "orderRemove.action?orderId="+delid;
                    $("#myModal").modal("show").on("shown", function () {
                        $("#delbtn2").attr('href', delurl);
                    });
                }
