        ...
        <div class="content">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="row-fluid">
                            <div class="btn-toolbar">
                                <a href="${pageContext.request.contextPath}/example/views/chef/chefadd.jsp" role="button" class="btn btn-primary" data-toggle="modal">
                                ...
                                <tbody>
                                    <c:forEach items="${cheflist}" var="c">
                                        <tr>
                                            ...
                                            <td><img src="${c.cplace}" height="160" width="350"/></td>
                                            <td>
                                                <a  class="btn btn-info" href="chefEdit.action?chefId=${c.chefId}"><i class="icon-edit icon-white"></i>修改</a>
                                                <button  onclick="del(this)"  delid="${c.chefId}" class="btn btn-danger"><i class="icon-trash icon-white"></i> 删除</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
            ...
            <script type="text/javascript">
                ...
                function del(obj) {
                    ...
                    var delurl = "chefRemove.action?chefId="+delid;
                    $("#myModal").modal("show").on("shown", function () {
                        $("#delbtn2").attr('href', delurl);
                    });
                }
