        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <form action="chefAdd" method="post" class="form-horizontal"  enctype="multipart/form-data" >    
                        <div class="row-fluid">
                            <div class="span7">
                                <div class="control-group">
                                    <label class="control-label" for="price">厨师姓名</label>
                                    <div class="controls">
                                        <input name="chefname" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>                                
                                <div class="control-group">
                                    <label class="control-label" for="name">厨师图片</label>
                                    <div class="controls">
                                        <input name="cplace" class="input-xlarge focused" id="name" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
