                ...
                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-content">
                            ...
                            <form class="form-horizontal" action="eimageUpdate" method="POST">
                                <fieldset>
                                    <div class="control-group">
                                        <label class="control-label">商店ID</label>
                                        <div class="controls">
                                            <input name="shopId" class="input-xlarge"  type="text" value="${requestScope.eimageEdi.shopId}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="desc">环境图片</label>
                                        <div class="controls">
                                            <input name="eplace" class="input-xlarge focused" id="desc" type="text" value="${requestScope.eimageEdi.eplace}">
                                        </div>
                                    </div>	
                                    <div class="control-group">
                                        <label class="control-label" for="desc">图片ID</label>
                                        <div class="controls">
                                            <input name="eid" class="input-xlarge focused" id="desc" type="text" readonly="true" value="${requestScope.eimageEdi.eid}"/>
                                        </div>
                                    </div>
