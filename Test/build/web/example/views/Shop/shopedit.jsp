...
<html lang="en">
    ...
    <body class=""> 
        ...
        <div class="content">
            ...
            <ul class="breadcrumb">
                <li>商店 <span class="divider">/</span></li>
                ...
                <div class="row-fluid sortable">
                    <div class="box span12">
                        <div class="box-content">
                            ...
                            <form class="form-horizontal" action="shopUpdate" method="POST">
                                <fieldset>
                                    <div class="control-group">
                                        <label class="control-label">商店名</label>
                                        <div class="controls">
                                            <input name="shopname" class="input-xlarge"  type="text" value="${requestScope.shopEdi.shopname}">
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label" for="orderid">城市</label>
                                        <div class="controls">
                                            <input name="city" class="input-xlarge focused" id="orderid" type="text" value="${requestScope.shopEdi.city}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="num">商店描述</label>
                                        <div class="controls">
                                            <input name="shopdescribe" class="input-xlarge focused" id="num" type="text" value="${requestScope.shopEdi.shopdescribe}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="desc">图片</label>
                                        <div class="controls">
                                            <input name="shopimage" class="input-xlarge focused" id="desc" type="text" value="${requestScope.shopEdi.shopimage}">
                                        </div>
                                    </div>	
                                    <div class="control-group">
                                        <label class="control-label" for="desc">商店ID</label>
                                        <div class="controls">
                                            <input name="shopId" class="input-xlarge focused" id="desc" readonly="true" type="text" value="${requestScope.shopEdi.shopId}"/>
                                        </div>
                                    </div>
