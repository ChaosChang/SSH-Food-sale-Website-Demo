        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <form action="shopAdd" method="post" class="form-horizontal"  enctype="multipart/form-data" >    
                        <div class="row-fluid">
                            <div class="span7">  	
                                <div class="control-group">
                                    <label class="control-label" for="name">商店名</label>
                                    <div class="controls">
                                        <input name="shopname" class="input-xlarge focused" id="name" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">城市</label>
                                    <div class="controls">
                                        <input name="city" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">商店描述</label>
                                    <div class="controls">
                                        <input name="shopdescribe" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">图片</label>
                                    <div class="controls">
                                        <input name="shopimage" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
