        ...
        <div class="content">
            ...
            <!-- 提示框2 -->
                ...
                <div class="header">
                    ...
                    <h1 class="page-title">食物</h1>
                </div>

                <ul class="breadcrumb">
                    <li>食物 <span class="divider">/</span></li>
                    <li class="active">食物查询</li>
                </ul>
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="row-fluid">
                            <div class="btn-toolbar">
                                <a href="${pageContext.request.contextPath}/example/views/gimage/gimageadd.jsp" role="button" class="btn btn-primary" data-toggle="modal">
                        ...
                        <div class="well">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                ...
                                <tbody>
                                    <c:forEach items="${gimagelist}" var="g">
                                        <tr>
                                            <td>${g.gid}</td>
                                            <td>${g.shopId}</td>
                                            <!--c:if test="$">
                                            ...
                                            <td><img src="${g.gplace}" height="150" width="200"/></td>
                                            <td>
                                                <a  class="btn btn-info" href="gimageEdit.action?gid=${g.gid}"><i class="icon-edit icon-white"></i>修改</a>
                                                <button  onclick="del(this)"  delid="${g.gid}" class="btn btn-danger"><i class="icon-trash icon-white"></i> 删除</button>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
            ...
            <script type="text/javascript">
                ...
                function del(obj) {
                    ...
                    var delurl = "gimageRemove.action?gid="+delid;
                    $("#myModal").modal("show").on("shown", function () {
                        $("#delbtn2").attr('href', delurl);
                    });
                }
