        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <form action="gimageAdd" method="post" class="form-horizontal"  enctype="multipart/form-data" >    
                        <div class="row-fluid">
                            <div class="span7">  	
                                <div class="control-group">
                                    <label class="control-label" for="name">食物图片</label>
                                    <div class="controls">
                                        <input name="gplace" class="input-xlarge focused" id="name" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
