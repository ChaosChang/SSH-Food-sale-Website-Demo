    ...
    <body class=""> 
        ...
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <a class="brand" href="/WirelessOrder/home.do?flag=home"><span class="first">OMEGA</span> <span class="second">后台</span></a>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <form action="goodAdd" method="post" class="form-horizontal"  enctype="multipart/form-data" >    
                        <div class="row-fluid">
                            <div class="span7">  	
                                <div class="control-group">
                                    <label class="control-label" for="name">商品名称</label>
                                    <div class="controls">
                                        <input name="goodname" class="input-xlarge focused" id="name" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">进价</label>
                                    <div class="controls">
                                        <input name="inprice" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">售价</label>
                                    <div class="controls">
                                        <input name="saleprice" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">生产日期</label>
                                    <div class="controls">
                                        <input name="pdate" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">销量</label>
                                    <div class="controls">
                                        <input name="salenumber" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">商家ID</label>
                                    <div class="controls">
                                        <input name="shopId" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="price">商品图片</label>
                                    <div class="controls">
                                        <input name="goodimage" class="input-xlarge focused" id="price" type="text" value="">
                                    </div>
                                </div>
                    ...
                    <footer>
                        <hr>
                        <p class="pull-right">
                            &copy; 2017.3 <a href="#" target="_blank"> Borrowed by Chaos</a>
                        </p>
                    </footer>
                </div>
            </div>
