                            ...
                            <form class="form-horizontal" action="userUpdate" method="POST">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="username" class="input-xlarge"  type="text" value="${requestScope.userEdi.username}">
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label" for="orderid">密码</label>
                                        <div class="controls">
                                            <input name="userpw" class="input-xlarge focused" id="orderid" type="text" value="${requestScope.userEdi.userpw}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="num">手机号</label>
                                        <div class="controls">
                                            <input name="userphone" class="input-xlarge focused" id="num" type="text" value="${requestScope.userEdi.userphone}">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="desc">地址</label>
                                        <div class="controls">
                                            <input name="useradd" class="input-xlarge focused" id="desc" type="text" value="${requestScope.userEdi.useradd}">
                                        </div>
                                    </div>	
                                    <div class="control-group">
                                        <label class="control-label" for="desc">用户ID</label>
                                        <div class="controls">
                                            <input name="userId" class="input-xlarge focused" id="desc" type="text" value="${requestScope.userEdi.userId}" readonly="true"/>
                                        </div>
                                    </div>
