...
<html>
    ...
    <body>
            ...
            <div class="banner ban1">
                <div class="container">
                    ...
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/example/gallery.jsp" class="active">美食展示</a></li>
        ...
        <!--end-banner-->
        <form action="searchShop2" method="post">
        ...
        <div class="content">
            ...
            <div class="gallery">
                <div class="container">
                    ...
                    <div class="gallery-info">
                        <c:forEach items="${currentgimage}" var="cg">
                            <div class="col-md-4 galry-grids moments-bottom">
                                <img src="${cg.gplace}" class="img-responsive" alt="">
                                <div class="b-wrapper">
            ...
            <div class="footer text-center">
                <div class="container">
                    ...
                    <div class="social">
                        <a href="404error.html"><span class="behance"></span></a>
                        <a href="404error.html"><span class="dribble"></span></a>
